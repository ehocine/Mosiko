...
object MusicUtil {
    ...
    fun getMusic(
        ...
        if (musicCursor != null) {
            ...
            cursorIndexMusicDuration =
                musicCursor.getColumnIndexOrThrow(MediaStore.Audio.Media.DURATION)
            cursorIndexMusicAlbumID =
                musicCursor.getColumnIndexOrThrow(MediaStore.Audio.Media.ALBUM_ID)
            cursorIndexMusicDateAdded =
                musicCursor.getColumnIndexOrThrow(MediaStore.Audio.Media.DATE_ADDED)
